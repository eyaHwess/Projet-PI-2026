...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     * @return string[]
     */
    public function getSpecialities(): array { return $this->specialities ?? []; }

    /**
     * @param string[] $specialities
     */
    public function setSpecialities(array $specialities): static { $this->specialities = $specialities; return $this; }
    ...
    public function setPricePerSession(?float $pricePerSession): static { $this->pricePerSession = $pricePerSession; return $this; }
    ...
    public function setProfilePictureName(?string $profilePictureName): void { $this->profilePictureName = $profilePictureName; }
    public function getProfilePictureName(): ?string { return $this->profilePictureName; }

    public function setProfilePictureSize(?int $profilePictureSize): void { $this->profilePictureSize = $profilePictureSize; }
    public function getProfilePictureSize(): ?int { return $this->profilePictureSize; }

    public function getFormattedProfilePictureSize(): string
    {
        if (!$this->profilePictureSize) return '0 B';
        $units = ['B', 'KB', 'MB', 'GB'];
    ...
    public function hasProfilePicture(): bool { return $this->profilePictureName !== null; }
    ...
    {
        if (!in_array($badge, $this->badges ?? [])) { $this->badges[] = $badge; }
        return $this;
    }

    public function getRespondsQuickly(): ?bool { return $this->respondsQuickly; }
    public function setRespondsQuickly(?bool $respondsQuickly): static { $this->respondsQuickly = $respondsQuickly; return $this; }

    public function getTotalSessions(): ?int { return $this->totalSessions; }
    public function setTotalSessions(?int $totalSessions): static { $this->totalSessions = $totalSessions; return $this; }
    ...
    public function isOnline(): bool
    {
        ...
        return ($now->getTimestamp() - $this->lastActivityAt->getTimestamp()) < 300;
    }

    public function getOnlineStatus(): string
    {
        if (!$this->lastActivityAt) return 'offline';
        $diff = (new \DateTimeImmutable())->getTimestamp() - $this->lastActivityAt->getTimestamp();
    ...
    public function removeGoal(Goal $goal): static
    {
        if ($this->goals->removeElement($goal)) {
            if ($goal->getUser() === $this) { $goal->setUser(null); }
        }
        return $this;
    }
     ...
     */
    public function getGoalParticipations(): Collection { return $this->goalParticipations; }
    ...
    public function removeGoalParticipation(GoalParticipation $goalParticipation): static
    {
        if ($this->goalParticipations->removeElement($goalParticipation)) {
            if ($goalParticipation->getUser() === $this) { $goalParticipation->setUser(null); }
        }
        return $this;
    }
    ...
    public function removeComment(Comment $comment): static
    {
        if ($this->comments->removeElement($comment)) {
            if ($comment->getCommenter() === $this) { $comment->setCommenter(null); }
        }
        return $this;
    }
    ...
    public function removePostLike(PostLike $postLike): static
    {
        if ($this->postLikes->removeElement($postLike)) {
            if ($postLike->getLiker() === $this) { $postLike->setLiker(null); }
        }
        return $this;
    }
    ...
    public function getArchetypeShortBio(): ?string { return $this->archetypeShortBio; }
    public function setArchetypeShortBio(?string $archetypeShortBio): static { $this->archetypeShortBio = $archetypeShortBio; return $this; }

    public function getArchetypeName(): ?string { return $this->archetypeName; }
    public function setArchetypeName(?string $archetypeName): static { $this->archetypeName = $archetypeName; return $this; }

    public function getArchetypeDescription(): ?string { return $this->archetypeDescription; }
    public function setArchetypeDescription(?string $archetypeDescription): static { $this->archetypeDescription = $archetypeDescription; return $this; }

    /** @return array<string, mixed>|null */
    public function getArchetypeData(): ?array { return $this->archetypeData; }

    /** @param array<string, mixed>|null $archetypeData */
    public function setArchetypeData(?array $archetypeData): static { $this->archetypeData = $archetypeData; return $this; }

    /** @return array<string, mixed>|null */
    public function getOnboardingAnswers(): ?array { return $this->onboardingAnswers; }

    /** @param array<string, mixed>|null $onboardingAnswers */
    public function setOnboardingAnswers(?array $onboardingAnswers): static { $this->onboardingAnswers = $onboardingAnswers; return $this; }
